...
use crate::ast::{
    ...
    UnaryOpr, VarBinder, VarIdent, Variant, TypDecorationArg,
};
...
pub(crate) fn coerce_typ_to_native(ctx: &Ctx, typ: &Typ) -> Typ {
    match &**typ {
        ...
        TypX::Decorate(d, targ, t) => Arc::new(TypX::Decorate(*d, targ.clone(), coerce_typ_to_native(ctx, t))),
...
pub(crate) fn coerce_typ_to_poly(_ctx: &Ctx, typ: &Typ) -> Typ {
    match &**typ {
        ...
        TypX::Decorate(d, targ, t) => Arc::new(TypX::Decorate(*d, targ.clone(), coerce_typ_to_poly(_ctx, t))),
        TypX::Boxed(_) | TypX::TypParam(_) | TypX::Projection { .. } => typ.clone(),
        TypX::TypeId => panic!("internal error: TypeId created too soon"),
