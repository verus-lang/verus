...
pub enum ExprX {
    ...
    ///
    /// This expr is generated internally as part of the atomic function call.
    /// Notably, this has nothing to do with Rust generators, we might want
    /// to rename this eventually, once those are implemented.
    Yield(AtomicCallInfo),
