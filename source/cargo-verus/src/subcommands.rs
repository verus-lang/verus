...
# use statements with the feature flag `verus_in_verification`, which Verus turns on during
# verification.
#
# WARNING: this flag should only be used on import statements, see the documentation
# (https://verus-lang.github.io/verus/guide/erasure.html) for more details.
#
# This lint suppression prevents cargo from complaining about the
# `verus_in_verification` feature flag being undeclared.
