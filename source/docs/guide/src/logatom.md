...
Here, a logically atomic function take a "ghost callback" which is invoked at the linearization point to temporarily acquire the caller's permission and update the relevant ghost state.
