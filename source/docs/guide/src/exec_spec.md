...
generated by `exec_spec_trusted!` is annotated with `[verifier::external_body]`, so
...
## Unverified translations of `vstd` functions within the `exec_spec!` and `exec_spec_trusted!` macros
