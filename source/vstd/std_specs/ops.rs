...
//     use core::ops::Neg;
// #[verifier::external_trait_specification]
// // #[verifier::external_trait_extension(NegSpec via NegSpecImpl)]
// pub trait ExNeg: core::marker::Sized {
//     type ExternalTraitSpecificationFor: core::ops::Neg;
...
//     fn neg(self) -> (ret: Self::Output)
//         requires
//             self.neg_req(),
//         ensures
//             Self::obeys_neg_spec() ==> ret == self.neg_spec();
// }
...
// trait NegSpecImpl: Neg {
//     #[cfg(verus_keep_ghost)]
//     fn obeys_neg_spec() -> bool;

//     #[cfg(verus_keep_ghost)]
//     fn neg_req(self) -> bool
//         where Self: Sized;

//     #[cfg(verus_keep_ghost)]
//     fn neg_spec(self) -> Self::Output
//         where Self: Sized;
// }
...
// PointeeSized bound relaxes otherwise-implicit sized bound. 

// Before, Neg had
// an implicit Sized bound, which is now an implicit `const MetaSized` bound. 
// */
// impl<A: Neg + core::marker::PointeeSized> NegSpec for A {
//     #[cfg(verus_keep_ghost)]
//     #[verifier::external_body]
//     fn obeys_neg_spec() -> bool { panic!() }
