        ...
        match (self, other) {
            ...
            (MonotonicCounterResourceValue::LowerBound{lower_bound: lower_bound1},
             MonotonicCounterResourceValue::LowerBound{lower_bound: lower_bound2}) => {
               let max_lower_bound = if lower_bound1 > lower_bound2 { lower_bound1 } else { lower_bound2 };
            ...
            (MonotonicCounterResourceValue::LowerBound{lower_bound}, MonotonicCounterResourceValue::FullRightToAdvance{value}) =>
               if lower_bound <= value { MonotonicCounterResourceValue::FullRightToAdvance{value} }
               else { MonotonicCounterResourceValue::Invalid{ } },
            (MonotonicCounterResourceValue::FullRightToAdvance{value}, MonotonicCounterResourceValue::LowerBound{lower_bound}) =>
               if lower_bound <= value { MonotonicCounterResourceValue::FullRightToAdvance{value} }
               else { MonotonicCounterResourceValue::Invalid{ } },
            ...
            (MonotonicCounterResourceValue::LowerBound{lower_bound}, MonotonicCounterResourceValue::HalfRightToAdvance{value}) =>
               if lower_bound <= value { MonotonicCounterResourceValue::HalfRightToAdvance{value} }
               else { MonotonicCounterResourceValue::Invalid{ } },
            (MonotonicCounterResourceValue::HalfRightToAdvance{value}, MonotonicCounterResourceValue::LowerBound{lower_bound}) =>
               if lower_bound <= value { MonotonicCounterResourceValue::HalfRightToAdvance{value} }
               else { MonotonicCounterResourceValue::Invalid{ } },
