...
fn run_examples() {
    ...
    for entry in entries {
        ...
        let script = format!(
            "../rust/install/bin/rust_verify --pervasive-path pervasive --extern builtin=../rust/install/bin/libbuiltin.rlib --extern builtin_macros=../rust/install/bin/libbuiltin_macros.dll --edition=2018 {}",
            &path
        );
