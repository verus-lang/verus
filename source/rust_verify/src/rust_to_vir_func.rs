        ...
        let new_func = ctxt.spanned_new(
            ...
            FunctionX {
                ...
                attrs: Arc::new(FunctionAttrsX {
                    ...
                    auto_reveal_strlit: functionx.attrs.auto_reveal_strlit,
                    auto_reveal_byteslit: functionx.attrs.auto_reveal_byteslit,
...
fn make_attributes<'tcx>(
    ...
    let fattrs = FunctionAttrsX {
        ...
        auto_reveal_strlit: vattrs.auto_reveal_strlit,
        auto_reveal_byteslit: vattrs.auto_reveal_byteslit,
