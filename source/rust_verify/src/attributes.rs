...
/// The proc macro uses this prefix for counterparts that carry an overriding impl's body.
/// It extends `WITH_PREFIX`, so it has to be stripped first.
pub(crate) const WITH_IMPL_PREFIX: &str = "_VERUS_WITH_IMPL_";
/// The proc macro uses this prefix for the companion trait that holds the specifications.
pub(crate) const WITH_TRAIT_PREFIX: &str = "_VERUS_WITH_TRAIT_";
/// The proc macro uses this prefix for the companion trait that holds overriding bodies.
pub(crate) const WITH_IMPL_TRAIT_PREFIX: &str = "_VERUS_WITH_IMPL_TRAIT_";
