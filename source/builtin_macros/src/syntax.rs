                                ...
                                if let Pat::Ident(x) = &trk.pat.elems[0] {
                                    ...
                                    let f: TokenStream = if path_is_ident(&trk.path, "Gho") {
                                        if self.pervasive_in_same_crate {
                                            ...
                                            quote_spanned!(span => veruslib::pervasive::modes::tracked_unwrap_gho)
                                        }
                                    } else {
                                        if self.pervasive_in_same_crate {
                                            quote_spanned!(span => crate::pervasive::modes::tracked_unwrap_trk)
                                        } else {
                                            quote_spanned!(span => veruslib::pervasive::modes::tracked_unwrap_trk)
                                        }
                                    };
                                    stmts.push(Stmt::Semi(
                ...
                match (is_inside_ghost, mode_block, &*unary.expr) {
                    ...
                    (false, (true, false), Expr::Paren(..)) => {
                        ...
                        *expr = Expr::Verbatim(if self.erase_ghost {
                            ...
                            quote_spanned!(span => #[verifier(ghost_wrapper)] /* vattr */ veruslib::pervasive::modes::ghost_exec(#[verifier(ghost_block_wrapped)] /* vattr */ #inner))
                        });
                    }
                    (false, (true, false), _) => {
                        *expr = Expr::Verbatim(
                    ...
                    (false, (true, true), Expr::Paren(..)) => {
                        ...
                        *expr = Expr::Verbatim(if self.erase_ghost {
                            ...
                            quote_spanned!(span => #[verifier(ghost_wrapper)] /* vattr */ veruslib::pervasive::modes::tracked_exec(#[verifier(tracked_block_wrapped)] /* vattr */ #inner))
                        });
                    }
                    (true, (true, true), _) => {
